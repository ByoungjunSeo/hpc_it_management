...
> ★ **새 세션은 여기부터**: 최신 상태는 —
> "★ v2.1.0 릴리스 종결(2026-07-14)" / "★ 대기/예약 항목(2026-07-14 기준)" / (이력)
...
**다음 마디: SSH/BMC 원격 접속 스위트(v2.2) 착수.** (V2.1_BACKLOG 순위 7 — BL-11 자격증명
암호화 선행 완료로 진입 가능. 웹 SSH 콘솔·BMC 접속 + BUG-2 전원제어 통합, 축소 범위로.)
...
| 항목 | 내용 | 시점/조건 |
|------|------|-----------|
| **v2.1.0 발송** | dist·공지 보관 완료(서버 v2/backups + 사무실 PC). **발송 시점 자유·필요 시** — 전달 매체(파일서버/USB) 사용자 결정 | 필요 시 |
